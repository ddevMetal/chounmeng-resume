...
export default function Summary() {
  return (
    <Section id="summary">
      ...
      <blockquote className="border-l-[3px] border-cv-teal bg-cv-card rounded-r-xl px-6 py-5 max-w-3xl space-y-3">
        <p className="text-cv-bright font-semibold leading-[1.85] text-[0.97rem]">{summary.tagline}</p>
        <p className="text-cv-text leading-[1.95] text-[0.97rem]">{summary.body}</p>
      </blockquote>
    </Section>
  );
}
